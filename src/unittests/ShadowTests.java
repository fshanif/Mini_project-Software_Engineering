...
public class ShadowTests {
	...
	public void SphereTriangleMove1() {
		...
		scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
				60, new Point3D(0, 0, 200)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-64, 34, 0), new Point3D(-34, 64, 0), new Point3D(-62, 62, 4)));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Point3D(-80, 80, -120), 1, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Point3D(-70, 60, -30), 1, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
