...
public class RenderTests {
    ...
    public void basicRenderTwoColorTest() {
        ...
        ImageWriter imageWriter = new ImageWriter("base render test ba1", 500, 500, 500, 500);
    ...
    public void basicRenderMultiColorTest() {
        ...
        ImageWriter imageWriter = new ImageWriter("color render test baba2", 500, 500, 500, 500);
